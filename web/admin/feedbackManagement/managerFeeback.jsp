...
<%@page import="com.gsm.data.model.Feedback"%>
                        ...
                        <div class="p-3">
                            <div class="card border-primary mb-3 p-3 " >
                                <div class="card-header  ">
                                    <h4 class="text-body"><b><%=feedback.getfTitle()%> for <%=feedback.getfGrievance().getgTitle()%> (<%=feedback.getfGID()%>)</b></h4>
                                </div>
                                <div class="card-body bg-light">
                                    ...
                                    <p class="card-text"><%=UtilityMethod.getTrimmedString(feedback.getfNote(), 400)%>.
                                        ...
                                        <span class="d-flex align-items-end">
                                            ...
                                            <button class="btn btn-success" ><a style="color:white;" href="<%=request.getContextPath()%>/GrievanceChat?gID=<%=feedback.getfGID()%>"><b>VIEW THIS GRIEVANCE</b></a></button>
                                            <% }%>
                                            <%if (feedback.getfTitle().equals("Service Complain Feedback")) {%>
                                            <button class="btn btn-danger" ><a style="color:white;" href="<%=request.getContextPath()%>/GrievanceChat?gID=<%=feedback.getfGID()%>"><b>VIEW THIS GRIEVANCE</b></a></button>
                                            <% }%>
                                            <%if (feedback.getfTitle().equals("Service Request to Re Open Grievance")) {%>
                                            <button class="btn btn-warning" ><a style="color:white;" href="<%=request.getContextPath()%>/GrievanceChat?gID=<%=feedback.getfGID()%>"><b>VIEW THIS GRIEVANCE</b></a></button>
                                            <% }%>
                                        </span>
                                    </p>
