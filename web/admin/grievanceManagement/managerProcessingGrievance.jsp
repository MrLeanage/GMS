                            ...
                            <div class="flex">
                                ...
                                <p class="m-0">
                                    ...
                                    <span class="d-flex align-items-end">
                                        ...
                                        <button class="btn-success" ><a style="color:white;" href="<%=request.getContextPath()%>/GrievanceChat?gID=<%=grievance.getgID()%>"><b>VIEW THIS GRIEVANCE</b></a></button>
                                        <% }%>
                                        <%if (grievance.getgStatus().equals("Finished")) {%>
                                        <button class="btn-warning" ><a style="color:white;" href="<%=request.getContextPath()%>/GrievanceChat?gID=<%=grievance.getgID()%>"><b>VIEW THIS GRIEVANCE</b></a></button>
                                        <% }%>
                                    </span>
                                </p>
