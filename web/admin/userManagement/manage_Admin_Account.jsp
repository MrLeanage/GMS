                                        ...
                                        <table class="table table-bordered table-striped mb-0 data-table sortable" id="usersTable">
                                            ...
                                            <tbody  id="myTable">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><button class="btn btn-danger" data-href="<%=request.getContextPath()%>/DeleteAdminInfo?eID=<%=userInfo.getuEmpID()%>" data-toggle="modal" data-target="#confirm-delete">DELETE</button></td>
