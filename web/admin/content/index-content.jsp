...
<%@page import="com.gsm.data.model.FeedbackPerformance"%>
...
<div class="container-fluid page__container">
    <div class="page-section">
        ...
        <div class="page-separator">
            <div class="page-separator__text">MY STATISTICS</div>
        </div>
                    ...
                    <div class="table-wrapper-scroll-y my-custom-scrollbar">
                        <table class="table table-bordered table-striped mb-0 data-table sortable" id="usersTable">
                            ...
                            <tbody  id="myTable">
                                ...
                                %>
                                <tr>
                                    <td><%=userInfo.getuEmpID()%></td>
                                    <td><%=userInfo.getuFName()%></td>
                                    <td><%=userInfo.getuLName()%></td>
                                    <td><%=userInfo.getuType()%></td>
                                    <td><%=userInfo.getuStatus()%></td>
                                    <td><a href="<%=request.getContextPath()%>/ManageEmployee" class="btn btn-primary">MANAGE EMPLOYEE</a></td>
