...
<%@page import="com.gsm.data.model.UserValidation"%>
                    ...
                    <div class="container-fluid page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                        <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                            ...
                            <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                                <h2 class="mb-0">EMPLOYEE ACCOUNTS</h2>

                                <ol class="breadcrumb p-0 m-0">
                                    <li class="breadcrumb-item">User Management - Reset Employee Account</li>
                                </ol>
                            </div>
                        </div> 
                    </div>
                ...
                <div class="container-fluid page__container">
                    <div class="page-section">
                        ...
                        <div class="page-separator">
                            <div class="page-separator__text">RESET EMPLOYEE</div>
                        </div>
                                ...
                                <div class="flex"
                                    ...
                                    <form action="<%=request.getContextPath()%>/ResetEmployeeInfo" >
                                        ...
                                        <button class="btn btn-primary"
                                                type="submit">RESET EMPLOYEE</button>
