       ...
       ArrayList<Grievance> grievanceList = new ArrayList<Grievance>();
        ...
        try{
            ...
            while(resultSet.next()){
                grievanceList.add( new Grievance(resultSet.getString(1), resultSet.getString(2), resultSet.getString(3), resultSet.getString(4), resultSet.getString(5), resultSet.getString(6), resultSet.getString(7), resultSet.getString(8), resultSet.getString(9), resultSet.getString(10), resultSet.getString(11)));
    ...
    public Grievance loadSpecificGrievance(String gID){
       Grievance grievance = null;
        try{
            ...
            ResultSet resultSet = preparedStatement.executeQuery();
            while(resultSet.next()){
                grievance = new Grievance(resultSet.getString(1), resultSet.getString(2), resultSet.getString(3), resultSet.getString(4), resultSet.getString(5), resultSet.getString(6), resultSet.getString(7), resultSet.getString(8), resultSet.getString(9), resultSet.getString(10), resultSet.getString(11));
            }
        }catch(SQLException exception){
            exception.printStackTrace();
        }
    ...
    public ArrayList<ChatMessage> getChatMessages(String gID){
       ArrayList<ChatMessage> chatGroupMessageData = new ArrayList<ChatMessage>();
        try{
            ...
            while(resultSet.next()){
                User user = new User();
                user.setuEmpID(resultSet.getString(4));
    ...
    public ArrayList<User> getGrievanceChatParticipants(String grievanceID){
       ArrayList<User> chatParticipants = new ArrayList<User>();
        try{
            ...
            while(resultSet.next()){
                User user = new User();
                user.setuEmpID(resultSet.getString(3));
