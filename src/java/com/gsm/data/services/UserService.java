...
public class UserService {
    ...
    public User loadSpecificUser(User user){
        ...
        try{
            ...
            while(resultSet.next()){
                resultUser = new User(resultSet.getString(1), resultSet.getString(2), resultSet.getString(3), resultSet.getString(4), resultSet.getString(5), resultSet.getString(6));
            }
        }catch(SQLException exception){
            exception.printStackTrace();
        }
    ...
    public boolean updateUserData(User user){
        ...
        try {
            ...
            preparedStatement.setString(5, user.getuEmpID());
            preparedStatement.execute();
            return true;
        } catch (SQLException ex) {
            Logger.getLogger(UserService.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public boolean updateUserPassword(User user){
        ...
        try {
            ...
            preparedStatement.setString(2, user.getuEmpID());
            preparedStatement.execute();
            return true;
        } catch (SQLException ex) {
            Logger.getLogger(UserService.class.getName()).log(Level.SEVERE, null, ex);
