...
public class GrievanceControllerServlet extends HttpServlet {
    ...
    private void loadPostNewGrievance(HttpServletRequest request,
        ...
        log("User :" + user.getuEmpID());
        Grievance grievance = new Grievance();
        grievance.setgUID(user.getuEmpID());
    ...
    private void loadEmployeeMyGrievances(HttpServletRequest request,
        ...
        request.getRequestDispatcher("/client/grievanceManagement/employeeGrievance.jsp").forward(request, response);
    ...
    private void getProcessingGrievance(HttpServletRequest request,
        ...
        User user = (User) session.getAttribute("authUser");
        ArrayList<Grievance> grievanceList = GrievanceController.getProcessingManagerGrievanceList(user.getuEmpID(), "Processing");
        request.setAttribute("grievanceList", grievanceList);
