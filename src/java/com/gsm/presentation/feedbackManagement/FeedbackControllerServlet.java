 ...
 */
package com.gsm.presentation.feedbackManagement;
...
import com.gsm.logic.controller.FeedbackController;
...
//      request.getRequestDispatcher("/Dashboard").forward(request, response);
    ...
    private void getGivenFeedbacks(HttpServletRequest request,
        ...
        ArrayList<Feedback> feedbackList = FeedbackController.getManager3Feedbacks(user.getuEmpID());
