...
public class StatisticController {
    ...
    public static ArrayList<Performance> getPerformanceData(String period) {
        ...
        for (User user : managerList) {
            ...
            Performance performanceStat = getUserPerformance(user.getuEmpID(), "All");

            Performance performance = new Performance();
            performance.setEmployeeID(user.getuEmpID());
...
//        for(Grievance grievance : grievanceService.getAllGrievanceList()){
//            if()
//        }
        return null;
    }
